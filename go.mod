module github.com/flanksource/batch-runner
...
require (
	...
	github.com/flanksource/commons-db v0.1.4
...
require (
	...
	github.com/flanksource/artifacts v1.0.18 // indirect
	github.com/flanksource/deps v1.0.19 // indirect
